...
function onDeviceReady() {
    ...
    var config = {
        ...
        plugins: "application_status health_connect phone_sensors",
                ...
                setTimeout(function() {
                    RadarPassivePlugin.configure(config, {
                        success: function (configureRes) {
                            ...
                            RadarPassivePlugin.setAuthentication(authentication, {
...
function onRadarReady() {
    ...
    RadarPassivePlugin.registerPluginListener({
        success: function(plugins) {
            console.log("Plugins active: " + plugins)
